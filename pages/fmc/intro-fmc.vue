<template>
  <div class="content m-2">
    ...
    <p>
      ルービックキューブ最少手数（Fewest Move
      Challenge：通称FMC）とは、世界キューブ協会(WCA:World Cube
    ...
    <p>
      また、持ち替え記号（(r), (u), (f)、またはx, y,
      z）を使うことも可能です（持ち替えは手数に含まれません）。
    </p>
    <p>ただし、中段層回転（M, S, E）は禁止されています。</p>
    <p>
      【参考】Cube Voyage :
      <a href="https://cubevoyage.net/how-to-solve/intermediate/notation/"
        >回転記号とは？</a
      >
    </p>
