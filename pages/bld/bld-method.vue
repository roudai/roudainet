<template>
  <div>
    ...
    <h3>EOEP + COCP</h3>
    <p>
      エッジ・コーナーそれぞれを、まず向きを合わせ(Edge(Corner) Orientation)、その後場所を合わせる(Edge(Corner)
      Permutation)というものです。ルービックキューブを目隠しで揃えるということが世界に広まったときに、最初に提案されたのがこの方法です。
    </p>
    <p>
    ...
    <p>といったデメリットがあり、今の時代に目隠しを始めるにおいて、この解法を選ぶ理由は全くありません。</p>
    <p>
    ...
    <h3>M2 + R2</h3>
    <p>
      Stefan Pochmannが2007に提唱した解法です(<a href="https://www.stefan-pochmann.info/spocc/blindsolving/M2R2/"
        >M2/R2 blindcubing methods</a
      >)。
    </p>
    <p>
      EOEP +
      COCPと違い、現在主流となっている向きと位置を同時に揃える方法の基礎となった解法です。エッジをM2法、コーナーをR2法と言われる方法で揃えます。必要な手順も少なく、目隠しで解くのに問題となるパリティ処理も簡単で、非常に優れた解法です。
    </p>
    <p>しかし、特にR2法については例外パターンが多く、手順を覚えるのが少し大変です。</p>

    <h3>M2 + COCP</h3>
    <p>
      エッジをM2法で、コーナーをCOCP法で解く、ハイブリッド方式です。コーナーをCOCPで解くデメリットはありますが、比較的分かりやすい解法のため、一時スタンダードな解法とされていました。
    </p>
    <p>しかし、やはり目隠し競技のスピード化に伴い、COCPは今では推奨されません。</p>

    <h3>M2 + Old Pochmann （おすすめ！）</h3>
    <p>
      エッジをM2法で、コーナーをOld
      Pochmann法で解く方法です。BLDを始めるにおいて、もっともスタンダードと言って良い方法です。
    </p>
    <p>
      Old Pochmann法は、前述のR2法よりも前にStefan
      Pochmannが提案したものですが、覚える手順がほとんどなく、またM2法と組み合わせることでパリティ（後述）の処理も簡単にすることができます。
    </p>
    ...
    <h2>パリティとは</h2>
    <p>目隠しで解くうえで、「パリティ」という言葉が必ずでてきます。</p>
    <p>
